      ...
      <div class="footer-1-top">
        <div class="main-container">
          <div class="footer-1-top-row">
            <a href="#" class="footer-1-logo w-inline-block"><img src="<?php echo get_stylesheet_directory_uri(); ?>/src/images/logo-mem2x.png" sizes="250px" srcset="<?php echo get_stylesheet_directory_uri(); ?>/src/images/logo-mem2x-p-500.png 500w, <?php echo get_stylesheet_directory_uri(); ?>/src/images/logo-mem2x.png 523w" alt="" class="image-7 logo"></a>
 ...
 <script type="text/javascript" src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=5fa45342033e749f917aad36"></script>
 <?php wp_footer(); ?>
